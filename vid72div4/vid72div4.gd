...
func _ready():
	...
	a = mk_number("72", null, pos0)
	divided = mk_operator(4,a[-1].position+Vector2(op_sep,0))
	b = mk_number("4", null, divided.position + Vector2(op_sep, 0))
	equals = mk_operator(0,b[-1].position+Vector2(op_sep,0))
	c = mk_number("18", null, equals.position + Vector2(op_sep, 0))
	line0 = mk_number("4", null, pos0a)
	...
	y += y_sep
	line1_a = mk_number("10", null, Vector2(x1-x_sep, y)) 
	line1_b = mk_number("40", null, Vector2(x2-x_sep, y)) 
	line1_c = mk_number("40", null, Vector2(x3-x_sep, y)) 	
	
	y += y_sep
	line2_a = mk_number("5", null, Vector2(x1, y)) 
	line2_b = mk_number("20", null, Vector2(x2-x_sep, y)) 
	line2_c = mk_number("60", null, Vector2(x3-x_sep, y)) 	
	
	y += y_sep
	line3_a = mk_number("3", null, Vector2(x1, y)) 
	line3_b = mk_number("12", null, Vector2(x2-x_sep, y)) 	
	line3_c = mk_number("72", null, Vector2(x3-x_sep, y)) 
	
	y += y_sep
	line4 = mk_number("18", null, Vector2(x1-x_sep, y)) 
